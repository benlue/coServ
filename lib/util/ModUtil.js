...
exports.renderPage = function renderPage(webSite, vname, inData, callback)  {
	var  srvObj = {query: inData, intPath: vname, viewPath: '/blocks/views' + vname,
				   postFix: 'html', isPage: true, hasView: true, txEncode: 'utf-8',
				   client: {category: 'desktop'}},
		 renderQ = new RenderQ( webSite, srvObj),
		 data = {value: inData};
	webSite.viewIt( renderQ, srvObj, data, function(isStream, result) {
