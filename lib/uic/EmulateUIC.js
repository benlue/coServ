    ...
    if (!xsRoot)  {
        ...
        if (mdata.errCode)
            ...
            if (!xsRoot)  {
                ...
                xsRoot = makeElement(uic, id, params, ctx, uicPath);
            }
        }
    }
    ...
    if (fs.existsSync(xsPath))  {
        ...
        node = new Promise( resolve => {
                    uic.then( u => {
                        ...
                        renderQ.buildModel(id, params, uicPath, renderQ, (model) => {
                            let  xsRoot;
                            if (model && model.errCode != 0)  {
                                ...
                                if (!xsRoot)  {
                                    ...
                                    xsRoot = makeElement(u, id, model, ctx, uicPath);
                                }
                            }
        ...
        node = new Promise( resolve => {
                    uic.then( u => {
                        ...
                        if (!xsRoot)  {
                            ...
                            xsRoot = makeElement(u, id, params, ctx, packPath + '/' + uicName);
                        }
...
function  makeElement(uic, id, params, ctx, uicPath)  {
    let  elm;
    try  {
