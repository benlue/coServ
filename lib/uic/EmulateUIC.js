...
function  requireBuild(id, params)  {
    ...
    return  runUIC(id, params, xsPath, uicPath, blockRoot);
}
...
function  importBuild(uicName, id, params)  {
    ...
    return  runUIC(id, params, xsPath, packPath + '/' + uicName, this.uicRoot);
}


function  runUIC(id, params, xsPath, uicPath, blockRoot)  {
