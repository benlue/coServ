...
function  loadDynaNode(webView, dynaNode, cb)  {
    ...
    async.parallel([
        ...
        function loadJs(callback)  {
            ...
            else  if (renderQ.isMain)  {
                // renderQ.isMain: this is the main block. We'll generate an empty controller for it
                // even if the controller is not defined.
                // this is because if a block does not have a controller, we won't be able to find the block by __.getCtrl()
