                ...
                if (stats && stats.isFile())  {
                    ...
                    emulator.runXS(cssID, uicPath, blockRoot, renderQ).then( xsElm => {
                        ...
                        try  {
                            ...
                            let  rtnObj = {
                                body: util.format('<div class="_xsErr">Block [%s] ran into problems:</div><pre>%s</pre>', webView.getOpPath(), err.stack)
                            };
                            cb( false, rtnObj );
                        }
                    })
                    .catch ( (e) => {
                        console.log( e.stack );
                        let  rtnObj = {
                            body: util.format('<div class="_xsErr">Block [%s] ran into problems: %s</div>', webView.getOpPath(), e)
                        };
                        cb( false, rtnObj );
                    });
                }
